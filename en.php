...
define('JAVASCRIPTWARNING', 'Please enable JavaScript');
...
define('SIZE', 'Size');
define('DOWNLOADS', 'Downloads');
define('UNNAMEDFOLDER', 'Unnamed Folder');
define('CREDITS', 'Credits');
define('COOKIENOTICE', 'Starfiles uses cookies for');
define('FOLDERDELETED', 'Folder Deleted');
define('ADDTOFOLDER', 'Add to Folder');
define('CREATECHILDFOLDER', 'Create Child Folder');
